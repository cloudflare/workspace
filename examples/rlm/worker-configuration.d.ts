/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 40d6a92571697071cf4d93aaa8f69de2)
// Runtime types generated with workerd@1.20260722.1 2026-06-04 experimental,nodejs_compat
interface __BaseEnv_Env {
	LOADER: WorkerLoader;
	AI: Ai;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_API_TOKEN: string;
	DirectAgent: DurableObjectNamespace<import("./worker/index").DirectAgent>;
	ExecutorAgent: DurableObjectNamespace<import("./worker/index").ExecutorAgent>;
	RlmAgent: DurableObjectNamespace<import("./worker/index").RlmAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DirectAgent" | "ExecutorAgent" | "RlmAgent";
	}
